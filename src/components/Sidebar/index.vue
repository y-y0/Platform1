<template>
  <div class="sidebar">
    ...
    <div class="content">
      <div class="top">
        <ul class="list-group">
          <router-link class="list-group-item active" data-icon="icon1" to="/home">
            <img
          ...
          <router-link class="list-group-item" data-icon="icon2" to="/home/recent_work">
            <img
          ...
          <router-link class="list-group-item" data-icon="icon6" to="/home/brand">
            <img
      ...
      <div class="bottom">
        ...
        <div class="progress" role="progressbar" aria-label="example" aria-valuenow="25" aria-valuemin="0"
          aria-valuemax="100">
          <div class="progress-bar" :style="{ width: leave1 + '%' }"></div>
        </div>
        <div class="data">
          <p class="left">空间使用</p>
          <p class="right">{{ leave1 }}/500MB</p>
        </div>


        <div class="progress" role="progressbar" aria-label="example" aria-valuenow="25" aria-valuemin="0"
          aria-valuemax="100">
          <div class="progress-bar" :style="{ width: leave2 + '%' }"></div>
        </div>
        <div class="data">
          <p class="left">剩余空间</p>
          <p class="right">{{ leave2 }}/500MB</p>
        </div>

        <a href="#" class="btn">
          <img src="./images/vip.png" alt="">升级权益
        </a>
      </div>
    </div>
  ...
  .content {
    ...
    .top {
      .list-group {
        ...
        .active {
          background: linear-gradient(to right, #6A2FFF 0%, #8C3DFF 53%, #AE4AFF 100%);
          border-radius: 5px;
          color: #FFFFFF;
    ...
    .bottom {
      ...
      .btn {
        ...
        border-radius: 7px;
        /* 新版/渐变紫20% */
        background: linear-gradient(90.00deg, rgba(106, 47, 255, 0.2), rgba(140, 61, 255, 0.2) 53%, rgba(174, 74, 255, 0.2) 100%);
        color: #474554;
        font-family: Inter;
        font-size: 12px;
        font-weight: 400;
