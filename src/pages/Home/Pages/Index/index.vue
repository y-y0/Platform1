<template>
  ...
  <div class="content">
    <div class="top">
      <h3>Hello! <span>欢迎使用家乐伴</span></h3>

      <div class="card">
        <img src="./images/img.png" class="card-img-top" alt="...">
        <p class="card-text">数字人制作</p>
      </div>
    </div>
